...
from moexalgo_fork.metrics import prepare_request, dataclass_it, pandas_frame
from moexalgo_fork.session import Session
from moexalgo_fork.tickers import _Ticker


class Currency(_Ticker):
    """ 
    Класс для работы с валютными инструментами.
    Больше информации о валютных инструментах можно найти на странице: https://moexalgo.github.io/des/supercandles/#_3
    ...
    .. code-block:: python
        ...
        # Получение информации о валютном инструменте
        >>> from moexalgo_fork import currency
        >>> cur = currency.get('USD000UTSTOM')
        >>> info = cur.info()
        >>> print(info)
        ...
        >>> from moexalgo_fork import currency
        >>> cur = currency.get('USD000UTSTOM')
        >>> tradestats = cur.tradestats(start='2021-01-01', end='2021-01-31')
        >>> print(tradestats)
    """
    
    _PATH = 'engines/currency/markets/selt'
    _TYPE = 'fx'
    _LIMIT = 25_000
    ...
    def tradestats(self, 
        ...
        Больше информации о метрике `TradeStat` можно найти на странице: https://moexalgo.github.io/des/supercandles/#tradestats_2
    ...
    def orderstats(self, 
                   *, 
                   ...
                   use_dataframe: bool = True) -> Union[iter, pd.DataFrame]:
        """
        Возвращает метрики `OrderStat` (статистику по заявкам) по заданным параметрам.
        Больше информации о метрике `OrderStat` можно найти на странице: https://moexalgo.github.io/des/supercandles/#orderstats_1
    ...
    def obstats(self, 
        ...
        Больше информации о метрике `ObStat` можно найти на странице: https://moexalgo.github.io/des/supercandles/#obstats_2
