...
class Stock(_Ticker):
    ...
    Больше информации об акциях можно найти на странице: https://moexalgo.github.io/des/supercandles/#_1
    ...
    .. code-block:: python
        ...
        >>> from moexalgo_fork import stocks
    ...
    def tradestats(self, 
        ...
        Больше информации о метрике `TradeStat` можно найти на странице: https://moexalgo.github.io/des/supercandles/#tradestats
    ...
    def orderstats(self, 
        ...
        Больше информации о метрике `OrderStat` можно найти на странице: https://moexalgo.github.io/des/supercandles/#orderstats
    ...
    def obstats(self, 
        ...
        Больше информации о метрике `ObStat` можно найти на странице: https://moexalgo.github.io/des/supercandles/#obstats
